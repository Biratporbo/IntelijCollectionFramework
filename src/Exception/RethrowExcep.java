package Exception;
//throw the StringIndexOutOfBoundsException
...
class A{
    void method1(){
        try{
            ...
            //exception is thrown in below statement because there is no index with val 5
...
public class RethrowExcep {
    public static void main(String[] args) {
        //create an object to A and call method()
        A a = new A();
        try{
            a.method1();
        }
